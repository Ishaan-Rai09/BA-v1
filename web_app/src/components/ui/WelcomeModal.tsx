          ...
          <LuxuryCard className="overflow-hidden p-0" variant="frosted" glowing>
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="relative h-64 md:h-auto overflow-hidden">
                ...
                <div className="absolute inset-0 bg-[url('/patterns/grid.svg')] opacity-20 z-20"></div>
                ...
                <motion.div 
                  ...
                  style={{ backgroundImage: `url(${steps[currentStep].image || '/welcome/default.jpg'})` }}
                />
